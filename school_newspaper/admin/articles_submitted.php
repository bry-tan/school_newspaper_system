        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    ...
                    <p class="lead mb-0">
                        Manage your articles, collaborate with other writers, and track your publishing journey.
                    </p>
                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <ul class="text-left small mb-0">
                                            ...
                                            <li>Student achievements and spotlights</li>
                                            <li>Club news and updates</li>
                                            <li>Opinion pieces and editorials</li>
                                            <li>Academic tips and study guides</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
