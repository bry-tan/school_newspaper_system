                ...
                <a href="writer/index.php" class="card-link">
                    <div class="card shadow-sm h-100">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text">
                                Join as a writer to create engaging articles, collaborate with peers, 
                            ...
                            <div class="mt-3">
                                ...
                                <span class="badge badge-success">Collaboration</span>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <a href="admin/index.php" class="card-link">
                    <div class="card shadow-sm h-100">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text">
                                Administrative access for managing articles, moderating content, 
                                and overseeing the publication process.
                            </p>
                            <div class="mt-3">
                                        ...
                                        <div class="mb-3">
                                            <?php if ($article['is_admin'] == 1): ?>
                                                <span class="admin-badge">
                                                    <i class="fas fa-crown"></i> Admin Post
                                                </span>
                                            <?php endif; ?>
                                        </div>
        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-12">
                    ...
                    <p class="text-muted mb-0">Empowering student voices through digital journalism</p>
                </div>
            </div>
        </div>
    </footer>
